...
class Login :
    ...
    def objetos_login(self):
        ...
        self.longiFrame = LabelFrame(self.loginW,bg="#BFBBB4",height=400,width=300)
        self.longiFrame.place(x=103,y=95)
        # colocando nosso title
        self.toplabel = Label(self.longiFrame,fg="black", bg="#BFBBB4", anchor="center",text="Login",font="arial 35 bold")
