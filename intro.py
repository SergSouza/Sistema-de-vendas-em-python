...
class splash:
    def __init__(self):
        ...
        main = LabelFrame(self.splashMainW,width=890,height=560,bg='darkgreen', relief='sunken')
        main.place(x=55,y=70)

        #trabalhando nossa imagen
        FotoFrame = LabelFrame(main,width=420,height=444,bg='darkgreen', relief='raised')
        foto =  Label(FotoFrame,image=img)
        foto.place (x=6,y=6)
        FotoFrame.place(x=10,y=100)

        #Label(main, text="", font="",bg="").place(x="",y="")
        Label(main,text="Sistema de vendas em python sqlite",font="arial 28 bold",bg="darkgreen").place(x="45",y="10")               
        Label(main,text="Faculdade FATEPI",font="arial 32 bold",bg="darkgreen").place(x="450",y="160")
        Label(main,text="CURSO: python (Prof= Aratã)",font="arial 16 bold",bg="darkgreen").place(x="445",y="260")
        Label(main,text="DESENVOLVEDOR: Sergio Souza",font="arial 16 bold",bg="darkgreen").place(x="445",y="310")
        Label(main,text="EMAIL: sergio.escureto@gmail.com",font="arial 16 bold",bg="darkgreen").place(x="445",y="360")
        Label(main,text="TELEFONE: (99) 984717748",font="arial 16 bold",bg="darkgreen").place(x="445",y="410")
